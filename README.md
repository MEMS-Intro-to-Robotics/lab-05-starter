...
- `scaffolds/`: the starting files for your package
  - `motion_planner.py`: milestone 1 is complete apart from choosing your own
    retract configuration; implement milestones 2 to 4
...
The checks confirm that the repository contains your package, the four script
...
screenshot, and your discussion answers.
